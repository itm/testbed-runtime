 ...
 *       &lt;attribute name="datatype" use="required" type="{http://wisebed.eu/ns/wiseml/1.0}dtypes" />
 *       &lt;attribute name="unit" use="required" type="{http://wisebed.eu/ns/wiseml/1.0}units" />
