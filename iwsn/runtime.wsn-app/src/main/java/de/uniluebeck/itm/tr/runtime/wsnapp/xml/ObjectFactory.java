 ...
 * de.uniluebeck.itm.tr.runtime.wsnapp.xml package. <p>An ObjectFactory allows you to programatically construct new
...
public class ObjectFactory {
	...
	private final static QName _Device_QNAME = new QName("http://itm.uniluebeck.de/tr/runtime/wsnapp/xml", "device");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package:
	 * de.uniluebeck.itm.tr.runtime.wsnapp.xml
	 */
	 ...
	 */
	@XmlElementDecl(namespace = "http://itm.uniluebeck.de/tr/runtime/wsnapp/xml", name = "device")
	public JAXBElement<WsnDevice> createDevice(WsnDevice value) {
		return new JAXBElement<WsnDevice>(_Device_QNAME, WsnDevice.class, null, value);
	}
