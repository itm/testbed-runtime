...
import com.cea.util.Helper.HelperUtilities;
import com.cea.util.saml.SAMLGenerator;
import com.cea.util.saml.SAMLInput;
import com.cea.util.saml.SignAssertion;
...
import fr.tr.certificate.SNAACertificate;
import fr.tr.certificate.SNAACertificateConfig;
	...
	public void setUp(final Module jpaModule) throws Exception {
		...
		final AbstractModule mocksModule = new AbstractModule() {
			...
			protected void configure() {
                ...
                SNAACertificateModule snaaCertificateModule = new SNAACertificateModule(snaaServiceConfig);
