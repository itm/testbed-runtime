...
public interface RS {
	 ...
	 * @param to
	 * @param from
	 * @return returns java.util.List<eu.wisebed.testbed.api.rs.v1.PublicReservationData>
	 ...
	 * @param authenticationData
	 * @param reservation
	 * @return returns java.util.List<eu.wisebed.testbed.api.rs.v1.SecretReservationKey>
	 * @throws RSExceptionException
