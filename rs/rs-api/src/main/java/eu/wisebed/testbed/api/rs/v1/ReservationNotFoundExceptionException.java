...
public class ReservationNotFoundExceptionException
	 ...
	 * @param faultInfo
	 */
	public ReservationNotFoundExceptionException(String message, ReservervationNotFoundException faultInfo) {
		super(message);
	 ...
	 * @param cause
	 */
	public ReservationNotFoundExceptionException(String message, ReservervationNotFoundException faultInfo, Throwable cause) {
		super(message, cause);
		this.faultInfo = faultInfo;
	}
