...
public class ShibbolethAuthenticatorHelper {

	private static final Logger log = LoggerFactory.getLogger(ShibbolethAuthenticatorHelper.class);
		...
		httpclient.addResponseInterceptor(new HttpResponseInterceptor() {
			...
			public void process(final HttpResponse response, final HttpContext context) throws HttpException,
				...
				if (contentEncodingHeader != null) {
					log.debug("{} Content-Encoding header: {} = {}", contentEncodingHeader.getName(),
