...
//
//	private static final NodeUrnPrefix NODE_URN_PREFIX = new NodeUrnPrefix("urn:wisebed:uzl2:");
//
//	private static final Set<NodeUrnPrefix> NODE_URN_PREFIXES = newHashSet(NODE_URN_PREFIX);
//
...
//		}
//
//		shiroSNAA = (ShiroSNAA) Guice
//				.createInjector(new ShiroSNAAModule(properties, NODE_URN_PREFIXES))
//				.getInstance(SNAA.class);
//	}
//
//	@Test
...
//			assertEquals(NODE_URN_PREFIX, sakList.get(0).getUrnPrefix());
...
//		authTriple.setUrnPrefix(NODE_URN_PREFIX);
...
//				createUsernameNodeUrnsMapList(ADMINISTRATOR1, NODE_URN_PREFIX, "urn:wisebed:uzl2:0x2211");
//		try {
...
//		List<UsernameNodeUrnsMap> usernameNodeUrnsMaps =
//				createUsernameNodeUrnsMapList(ADMINISTRATOR1, NODE_URN_PREFIX, "urn:wisebed:ulanc:0x1211");
//		try {
...
//		List<UsernameNodeUrnsMap> usernameNodeUrnsMaps =
//				createUsernameNodeUrnsMapList(EXPERIMENTER1, NODE_URN_PREFIX, "urn:wisebed:uzl2:0x2211");
//		try {
...
//		List<UsernameNodeUrnsMap> usernameNodeUrnsMaps =
//				createUsernameNodeUrnsMapList(SERVICE_PROVIDER1, NODE_URN_PREFIX, "urn:wisebed:uzl2:0x2211");
//		try {
...
//		List<UsernameNodeUrnsMap> usernameNodeUrnsMaps =
//				createUsernameNodeUrnsMapList(SERVICE_PROVIDER1, NODE_URN_PREFIX, "urn:wisebed:uzl2:0x2311");
//		try {
//			assertFalse(shiroSNAA.isAuthorized(usernameNodeUrnsMaps, WSN_FLASH_PROGRAMS).isAuthorized());
//		} catch (SNAAFault_Exception e) {
//			log.error(e.getMessage(), e);
