...
public class PortalConfig extends ConfigWithLogging {
	...
	static {
		DEFAULT_DEVICE_CONFIG_DB_PROPERTIES.put(HIBERNATE_CONNECTION_URL, "jdbc:derby:memory:DeviceConfigDB;create=true");
		...
		DEFAULT_DEVICE_CONFIG_DB_PROPERTIES.put(HIBERNATE_HBM2DDL_AUTO, "create-drop");
