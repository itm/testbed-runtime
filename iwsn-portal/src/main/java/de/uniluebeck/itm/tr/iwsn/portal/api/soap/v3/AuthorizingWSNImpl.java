...
/**
 * Instances of this class make sure that WSN functionalities are only provided for users
 * which are authorized by a provided {@linl SNAA} component.<br/><br/>
 * The authorization is performed for each of the actions separately in case that
 * some actions are allowed for the user but others are not.<br/>
 * Furthermore Exceptions will be thrown in case the action is not allowed.
 */
public class AuthorizingWSNImpl implements AuthorizingWSN{
	...
	/**
	 * Constructor
	 * @param snaa The component used to check whether a certain action is authorized for a certain user
	 * @param portalConfig The portal servers configuration parameters
	 * @param reservation A user's reservation
	 * @param wsnDelegate The WSN instance which actually provides the WSN functionality
	 */
	@Inject
	 ...
	 * @param requestedAction The action to be authorized
